            ...
            <div class="row align-content-center align-items-center mb-7">
                ...
                <div class="col-12 col-lg-6">
                    <div class="col-12 col-lg-12 mx-auto p-5">
                        ...
                        <p data-aos="fade-up" data-aos-duration="1400" data-aos-delay="600">
                            <a href="#!" class="btn btn-warning text-color-white btn-rounded-20p icon-move-right">Leer
                                más
        ...
        <div class="row">
            <div class="col-12 col-6 mx-auto text-center mb-5">
                <h3 class="text-color-grey" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">Lorem ipsum
                    dolor sit amet,<br> consectetur adipisicing.</h3>
            </div>
        </div>
        <div class="row">
            <div class="col-12 col-lg-4 mt-4 mt-lg-0">
            ...
            <div class="col-12 col-lg-4 mt-4 mt-lg-0">
                <div class="card text-start text-color-dark" data-aos="zoom-in" data-aos-duration="1200"
                    data-aos-delay="400">
                    <div class="card-body pb-0 p-0 m-0">
                        <div class="p-4 mb-0">
                            <h4 class="mb-1">Lorem ipsum dolor sit amet.</h4>
            ...
            <div class="col-12 col-lg-4 mt-4 mt-lg-0">
                <div class="card text-start text-color-dark" data-aos="zoom-in" data-aos-duration="1300"
                    data-aos-delay="500">
                    <div class="card-body pb-0 p-0 m-0">
                        <div class="p-4 mb-0">
                            <h4 class="mb-1">Lorem ipsum dolor sit amet.</h4>
