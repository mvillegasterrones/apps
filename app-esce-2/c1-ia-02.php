...
<body class="case-study bg-gray-200">
    ...
    <header class="fadeIn1"
        style="background: url('./assets/img/hero/hero-card-01.png') no-repeat center center;background-size: cover;background-image: linear-gradient(var(--main-bg-color-dark), rgba(0, 123, 255, 0.1)), url('<?= $img_ia_02 ?>');"
            ...
            <div class="container">
                <div class="row p-3">
                    <div
                        ...
                        <h6 class="mb-1 text-white fadeIn2 fadeInBottom"><?= $ia_subtitulo_02 ?></h6>
                        <h1 class="text-white fadeIn2 fadeInBottom"><?= $ia_titulo_02 ?></b>
                        </h1>
    ...
    <div class="container mt-5">
        ...
        <section id="question" class="mb-7">
            <div class="row align-items-center">
                ...
                <div class="col-12 col-lg-6">
                    <img src="<?= $img_ia_02 ?>" class="w-100 h-100" alt="">
                </div>
            </div>
        </section>
