...
<body class="case-study bg-gray-200">
    ...
    <header>
    <div class="page-header min-vh-75" loading="lazy"><!--  style="background-image: url('<?= $img_hero_01 ?>');" -->
      <span class="mask bg-gradient-dark opacity-5"></span>
      <div class="container">
        <div class="row p-3">
          <div class="col-lg-9 col-md-12 d-flex justify-content-center text-md-start text-center flex-column mt-sm-0 mt-7">
            <h1 class="text-color-white rounded rounded-15 mb-0"><strong class="p-1 bg-primary" style="border-radius:15px !important; font-size: 4rem;font-weight: lighter !important;">ESCE</strong></h1>
            <h1 class="text-color-white">Escuela de Ciencias Emopresariales y Gestión Pública</h1>
            <p class="lead mt-0 mb-1 p-2 rounded rounded-15 blur pe-md-5 me-md-5 text-color-secondary opacity-8"><i class="material-icons">check_circle</i> Capacitación y Certificación en Crecimiento Empresarial.</p>
            <p class="lead mt-0 mb-1 p-2 rounded rounded-15 blur pe-md-5 me-md-5 text-color-secondary opacity-8"><i class="material-icons">check_circle</i> Desarrolla tus habilidades y avanza en tu carrera profesional..</p>
            ...
            <div class="buttons">
              <a href="#section-cursos"><button type="button" class="btn bg-gradient-primary mt-4">Próximos cursos</button></a>
              <a href="<?= $ruta_nosotros ?>"><button type="button" class="btn text-white shadow-none mt-4">Nosotros</button></a>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="card card-body blur shadow-blur mx-3 mx-md-7 mt-n6 mb-4"><!-- card card-body mb-7 shadow-xl mx-3 mx-md-4 mt-n6 -->
            ...
            <div class="container">
                ...
                <div class="row my-5">
                    <div class="col-md-10 mx-auto">
                        ...
                        <p class="text-start">
                        <h1 class="text-center">Aqui un slider con los cursos</h1>
                        </p>
                    </div>
                </div>
        ...
        <section class="my-5 pt-5 bg-gradient-info rounded rounded-15 text-color-white">
            <div class="container">
                <div class="row mb-5">
                    <div class="col-md-6 m-auto">
                        ...
                        <div class="row">
                            ...
                            <div class="col-4 ps-0">
                                <button type="button"
                                    class="btn bg-gradient-primary mb-0 h-100 position-relative z-index-2">Suscribirme</button>
                            </div>
                        </div>
                    </div>
