...
<body class="case-study bg-gray-200">
    ...
    <div class="card card-body mb-7 shadow-xl mx-3 mx-md-7 mt-n6">
        <section class="py-md-2 px-lg-5 pb-5">
            <div class="container">
                <h2 class="text-color-grey"><img src="<?= $ico ?>" class="w-5"> Servicios</h2>
                ...
                <!--<div class="row mt-5 align-items-center">
                    ...
                    <div class="col-6">
                        <h3 class="text-color-grey">Innovación de Productos o Servicios</h3>
                        <p>Rivalidad basada en innovación y diferenciación a través de la mejora de nuevos productos o
                            servicios, o la creación de nuevos negocios.</p>
                    </div>
                </div>-->
            </div>
        </section>
                    ...
                    <div class="card">
                        ...
                        <div class="accordion p-3" id="accordionPricing">
                            <div class="accordion-item mb-3">
                                ...
                                <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionPricing"><!-- SHOW -->
