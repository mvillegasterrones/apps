                            ...
                            <form id="form-enc-04" name="form-enc-04"
                                ...
                                <div class="card multisteps-form__panel p-3 border-radius-xl bg-white js-active text-uppercase"
                                    ...
                                    <div class="multisteps-form__content">
                                        ...
                                        <h6 class="font-weight-bolder mt-2 mb-0">II.4 Infraestructyura y equipamiento
                                            del desarrollo del área de EPT
                                        </h6>
                                        ...
                                        <h5 class="mt-5">III. sOBRE LOS CONVENIOS PARA MEJORAR LA FORMACIÓN EN EL ÁREA
                                            DE EPT</h5>
