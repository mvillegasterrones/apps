                ...
                <div class="d-flex align-items-center" id="sidenav-collapse-main">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item" data-mdb-ripple-init>
                            <a class="nav-link" style="color: rgb(226, 160, 48) !important;" href="./" id="link-nav" onclick="">Inicio</a>
                        </li>
                        <li class="nav-item" data-mdb-ripple-init>
                            <a class="nav-link" style="color: rgb(226, 160, 48) !important;" href="./about-us.php" onclick="">Nosotros</a>
                        </li>
                        <li class="nav-item" data-mdb-ripple-init>
                            <a class="nav-link" style="color: rgb(226, 160, 48) !important;" href="./courses.php" onclick="">Cursos</a>
                        </li>
                        <?= $user_nav_bar ?>
                        <li class="nav-item" data-mdb-ripple-init>
                            <a class="nav-link" style="color: rgb(226, 160, 48) !important;" href="javascript:;">
                                <?= $icono_user ?>
                            </a>
                        </li>
                        <?= $btn_login ?>
