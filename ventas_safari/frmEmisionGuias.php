...
ventana_secundaria = window.open("frmEmisionDeGuias.php","ventanaD","toolbar=no, scrollbars=no, resizable=no, top=100, left=140, width=1040, height=400");
} 
...
$(document).ready(function(){
          ...
          $.ajax({url:"phpProcess/FillEmisionGuiasFechas.php",cache:false,type:"GET",data:{des:tde,has:tha},success:function(result){
                $("#tabdet").html(result);
           }});
         });
         })
...
$(document).ready(function(){
          ...
          {        
          $.ajax({url:"phpProcess/FillEmisionGuiasCliente.php",cache:false,type:"GET",data:{cli:tCl},success:function(result){
                $("#tabdet").html(result);
           }});
          }
         });
 ...
 $(document).ready(function(){
          ...
          {        
          $.ajax({url:"phpProcess/FillEmisionGuiasSerieNumero.php",cache:false,type:"GET",data:{sp:tSP,ser:tSer,num:tNum},success:function(result){
                $("#tabdet").html(result);
           }});
          }
         });
...
<table>
	...
	<fieldset style="background-color: #A7F5EF">
		...
		<table>
			<tr><td>Documento 
				<td><input type="text" id="SPed" value="GR" size="1" readonly/>
