...
<title>Emision de Nota de Credito</title>
...
ventana_secundaria = window.open("frmEmisionDeNC.php","ventanaK","toolbar=no, scrollbars=no, resizable=no, top=100, left=140, width=820, height=415");
} 
