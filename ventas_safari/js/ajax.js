...
var Servidor="js/consulta.php"; // Determina la pagina donde buscar
...
function Contenido(idContenido)
{
	...
	// Deshabilitamos la visualizaci�n del reloj
...
function Solicitud(idContenido,Cadena)
{
	...
	if(Cadena && Cadena!=Palabra)
	{
		...
		if(Conexion)
		{
			// Habilitamos la visualizaci�n del reloj
...
function selectItem(idContenido,value)
{
	...
	document.getElementById("txtCliente").value=value;
