...
<head>
  <?php include 'js/autocompletar.php'; ?>
    ...
    <title>Guia de Pedido - Tienda</title>
...
<div class="formulario">
    ...
    <table>
        <tr>
            <td>Nro.Doc.:<td><select id="cboDocumento" name="cboDocumento">
                    <?php 
            ...
            <td><input type="text" id="txtNumero" name="txtNumero" value="" size="8"/>
               ...
               <!-- <td>Percepcion:
                <td><input type="text" id="txtPercepcion" name="txtPercepcion" value="0.00" size="3" readonly/>%
               -->
        </tr>
        <tr>
            <td>Cliente:
            ...
            <td colspan="7"><select id="cboDirAgencia" name="cboDirAgencia" style="width: 540">
                    <?php 
                        //                //session_start();
                        //                $empresa=$_SESSION['id_empresa'];
                        //filtrar_combo_id("select d.dirs_id, d.dirs_nomb from direcciones d 
                        //                inner join empresas e on e.empr_id = d.empr_id where 
                        //                e.empr_id ='$empresa' ");
                    ?>
                </select>    
        </tr>
