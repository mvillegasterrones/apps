...
ventana_secundaria = window.open("frmPercepcionDeVenta.php","ventanaJ","toolbar=no, scrollbars=no, resizable=no, top=100, left=140, width=870, height=457");
} 
...
<table>
	...
	<fieldset style="background-color: #A7F5EF">
		<legend style="font-size: 16px">Consulta de Documentos</legend>
		<table>
			<tr><td>Documento 
...
<table border="0" border-color=r"red">
	<tr bgcolor="#242DAE" >
		...
		<th width="70px"><font color="#FAF8F8">Importe
