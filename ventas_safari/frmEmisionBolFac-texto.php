...
<title>Emision FV/BV - Texto</title>
...
ventana_secundaria = window.open("frmEmisionDeFacturas-texto.php","ventanaF","toolbar=no, scrollbars=no, resizable=no, top=100, left=140, width=793, height=435");
} 
...
$(document).ready(function(){
          ...
          $.ajax({url:"phpProcess/FillEmisionFVBVFechas-texto.php",cache:false,type:"GET",data:{des:tde,has:tha},success:function(result){
                $("#tabdet").html(result);
           }});
         });
         })
...
$(document).ready(function(){
          ...
          {        
          $.ajax({url:"phpProcess/FillEmisionFVBVCliente-texto.php",cache:false,type:"GET",data:{cli:tCl},success:function(result){
                $("#tabdet").html(result);
           }});
          }
         });
 ...
 $(document).ready(function(){
          ...
          {        
          $.ajax({url:"phpProcess/FillEmisionFVBVSerieNumero-texto.php",cache:false,type:"GET",data:{sp:tSP,ser:tSer,num:tNum},success:function(result){
                $("#tabdet").html(result);
           }});
          }
         });
