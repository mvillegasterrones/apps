...
ventana_secundaria = window.open("frmEmisionDeFacturas.php","ventanaE","toolbar=no, scrollbars=no, resizable=no, top=100, left=140, width=880, height=437");
} 
...
$(document).ready(function(){
          ...
          $.ajax({url:"phpProcess/FillEmisionFVBVFechas.php",cache:false,type:"GET",data:{des:tde,has:tha},success:function(result){
                $("#tabdet").html(result);
           }});
         });
         })
...
$(document).ready(function(){
          ...
          {        
          $.ajax({url:"phpProcess/FillEmisionFVBVCliente.php",cache:false,type:"GET",data:{cli:tCl},success:function(result){
                $("#tabdet").html(result);
           }});
          }
         });
 ...
 $(document).ready(function(){
          ...
          {        
          $.ajax({url:"phpProcess/FillEmisionFVBVSerieNumero.php",cache:false,type:"GET",data:{sp:tSP,ser:tSer,num:tNum},success:function(result){
                $("#tabdet").html(result);
           }});
          }
         });
