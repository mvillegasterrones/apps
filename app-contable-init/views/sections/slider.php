<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4" id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="https://demos.creative-tim.com/argon-dashboard-pro/pages/dashboards/default.html " target="_blank">
            ...
            <span class="ms-1 font-weight-bold">
                <img src="<?= $ruta_local ?>assets/img/logos/empresas/logo-empresa-jym.png" style="width: 200px !important;" alt="MI-LOGO">
            </span>
        </a>
    </div>
                ...
                <!--<div class="collapse show" id="dashboardsExamples">
                    <ul class="nav ms-4">
                        ...
                        <li class="nav-item active">
                            <a class="nav-link active" href="../../pages/dashboards/automotive.html">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="collapse" aria-expanded="false" href="#vrExamples">
                                ...
                                <span class="sidenav-normal">
                                    Virtual Reality <b class="caret"></b></span>
                            </a>
                    ...
                    <ul class="nav ms-4">
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="collapse" aria-expanded="false" href="#gettingStartedExample">
                                ...
                                <span class="sidenav-normal">
                                    Getting Started <b class="caret"></b></span>
                            </a>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="collapse" aria-expanded="false" href="#foundationExample">
                                ...
                                <span class="sidenav-normal">
                                    Foundation <b class="caret"></b></span>
                            </a>
    ...
    <div class="sidenav-footer mx-3 my-3">
        <div class="card card-plain shadow-none" id="sidenavCard">
            <img class="w-60 mx-auto" src="../main-template/assets/img/illustrations/icon-documentation.svg" alt="sidebar_illustration" />
