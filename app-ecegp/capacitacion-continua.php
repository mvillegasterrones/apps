...
<body>
        ...
        <div id="carouselMaterialStyle" class="carousel slide carousel-fade vh-50" data-mdb-ride="carousel"
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <div class="bg-image">
                        <img src="https://media.licdn.com/dms/image/D4E12AQHqyXP2u0GYTA/article-cover_image-shrink_720_1280/0/1687834771945?e=2147483647&v=beta&t=3lSPmmaOKJ5v3nNWuXi1SboIU-mIImR2y1957X5i56U" class="w-100" alt="Louvre Museum" />
                        <div class="mask"
                ...
                <div class="carousel-item">
                    <div class="bg-image">
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQOnuQyLj9NqElcu2PCcuBE1kgCHpK3praJfg&s" class="w-100" alt="Louvre Museum" />
                        <div class="mask"
                            style="background: linear-gradient(45deg, hsla(168, 85%, 52%, 0.7), hsla(263, 88%, 45%, 0.7) 100%);">
                            <div class="d-flex justify-content-center align-items-center h-100">
                                <div class="row">
    ...
    <main>
        <div class="container">
            <div class="row mb-7">
                <div class="col-12" data-mdb-animation-init data-mdb-animation-start="onScroll" data-mdb-animation="fade-in"
                data-mdb-animation-show-on-load="false" data-mdb-animation-delay="100">
                    <div class="card main-bg-color-grey" data-mdb-animation-init data-mdb-animation-start="onScroll"
                        ...
                        <div class="card-body">
                            ...
                            <p class="text-muted">
                            Los programas de certificación que siguen metodologías flexibles y aplicadas están diseñados para satisfacer las necesidades de los profesionales modernos que buscan adquirir conocimientos prácticos y relevantes que puedan aplicar de inmediato en su entorno laboral. Estos programas son ideales para quienes valoran el aprendizaje enfocado en resultados tangibles y desean mejorar continuamente sus competencias para mantenerse competitivos en un mercado laboral en constante evolución.<br><br>
El objetivo de estos programas es proporcionar a los participantes las herramientas y habilidades necesarias para enfrentar los desafíos actuales de sus profesiones. Los participantes pueden aprender a su propio ritmo, adaptando el contenido a sus horarios y necesidades específicas. Esta flexibilidad permite que, sin importar las responsabilidades laborales o personales, puedan acceder a una formación de calidad que incrementará su potencial de empleabilidad. Además, estos programas ofrecen una excelente oportunidad para conectar con otros profesionales con intereses comunes a nivel nacional.
                            </p>
                        </div>
                    </div>
                </div>
